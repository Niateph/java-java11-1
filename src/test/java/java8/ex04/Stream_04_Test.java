...
public class Stream_04_Test {
	...
	streamBuilder.add("Alexandra");
	streamBuilder.add("Cyril");
	streamBuilder.add("Johnny");
	streamBuilder.add("Marion");
	streamBuilder.add("Sophie");
        Stream<Object> result = streamBuilder.build();
